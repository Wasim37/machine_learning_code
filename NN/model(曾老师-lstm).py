...
class Model(object):
    ...
    def IDCNN_layer(self, model_inputs, 
        ...
        """
        # tf.expand_dims����tensor�в���һ��ά�ȣ�����λ�þ��ǲ��������λ�ã�ά�ȴ�1��ʼ����
            ...
            for j in range(self.repeat_times):
                for i in range(len(self.layers)):
                    ...
                    with tf.variable_scope("atrous-conv-layer-%d" % i,
                        ...
                        #rate�� 
                        #Ҫ����һ��int�͵������������ľ������Ӧ�û���stride��������˵Ļ��������������ǿն������û��stride�����ģ���һ������Ҫע�⡣ȡ����֮����ʹ�����µ�rate��������ôrate������ʲô���أ�������Ϊ����������ͼ���Ͼ��ʱ�Ĳ����������������Ϊ����˵��д����ˣ�rate-1�������ġ�0������ԭ���ľ���˲���˺ܶࡰ�����������������ʱ���൱�ڶ�ԭͼ��Ĳ����������ˡ�������ô��ã����Կ����������ϸ����������ʱ���Ǻ����׵ó�rate=1ʱ����û��0���룬��ʱ��������ͱ������ͨ�����  
                        #padding�� 
    ...
    def loss_layer(self, project_logits, lengths, name=None):
        ...
        with tf.variable_scope("crf_loss"  if not name else name):
            ...
            #inputs: һ����״Ϊ[batch_size, max_seq_len, num_tags] ��tensor,һ��ʹ��BILSTM����֮�����ת��Ϊ��Ҫ�����״��ΪCRF�������. 
    ...
    def decode(self, logits, lengths, matrix):
        ...
        for score, length in zip(logits, lengths):
            ...
            #viterbi_decode���þ��Ƿ�����õı�ǩ����.�������ֻ�ܹ��ڲ���ʱʹ��,��tensorflow�ⲿ����
            #score: һ����״Ϊ[seq_len, num_tags] matrix of unary potentials. 
            #transition_params: ��״Ϊ[num_tags, num_tags] ��ת�ƾ���
            #viterbi: һ����״Ϊ[seq_len] ��ʾ����߷ֵı�ǩ�������б�. 
